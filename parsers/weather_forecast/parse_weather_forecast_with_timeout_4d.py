...
for i in range(8, 40, 8):
    ...
    date_splitted =          date_splitted.split("-")

    phrodo_phroneme = ""


    if int(date_splitted[2]) == 1 or int(date_splitted[2]) == 21:

        phrodo_phroneme = "st"

        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"] = {}

        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["temperature"] = ""
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["humidity"] = ""
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["wind_speed"] = ""
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["feels_like_temp"] = ""
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["date"] = ""

        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["temperature"] = weather_temp
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["humidity"] = humidity
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["wind_speed"] = wind_speed
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["feels_like_temp"] = feels_like_temp_str
        weather_data[f"{date_splitted[2]}{phrodo_phroneme} day"]["date"] = date

    if int(date_splitted[2]) == 2 or int(date_splitted[2]) == 22:
    ...
    if int(date_splitted[2]) == 3 or int(date_splitted[2][1:]) == 23:
    ...
    if 3 < int(date_splitted[2]) <= 20 or 23 < int(date_splitted[2]) <= 30:
...
file = "/home/time-traveller/macros/scripts/cdh/weather_new_data_4d.txt"
