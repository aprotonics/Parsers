...
file = "/home/time-traveller/macros/scripts/cdh/global_indexes/global_index_data_sp500_filtered.txt"
...
inc_previous_data2 = inc_data_lines[inc_data_lines_length-10]
...
inc_previous_data3 = inc_data_lines[inc_data_lines_length-27]
...
inc_previous_price = int(inc_previous_data_close_list[1][:3]) + int(inc_previous_data_close_list[1][4:]) / 100
inc_previous_price2 = int(inc_previous_data2_close_list[1][:3]) + int(inc_previous_data2_close_list[1][4:]) / 100
inc_previous_price3 = int(inc_previous_data3_close_list[1][:3]) + int(inc_previous_data3_close_list[1][4:]) / 100

if len(inc_previous_data_close_list[1][4:]) == 1:
    inc_previous_price = int(inc_previous_data_close_list[1][:3]) + int(inc_previous_data_close_list[1][4:] + str(0)) / 100

if len(inc_previous_data2_close_list[1][4:]) == 1:
    inc_previous_price2 = int(inc_previous_data2_close_list[1][:3]) + int(inc_previous_data2_close_list[1][4:] + str(0)) / 100

if len(inc_previous_data3_close_list[1][4:]) == 1:
    inc_previous_price3 = int(inc_previous_data3_close_list[1][:3]) + int(inc_previous_data3_close_list[1][4:] + str(0)) / 100

procentile = int() 
procentile = ((inc_previous_price2 - inc_previous_price3) / inc_previous_price3) * 1000
