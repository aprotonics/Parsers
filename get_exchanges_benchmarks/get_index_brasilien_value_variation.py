...
file = "/home/time-traveller/macros/scripts/cdh/global_indexes/global_index_data_ibovespa_filtered.txt"
...
inc_previous_price = int(inc_previous_data_close_list[1][:2]) + int(inc_previous_data_close_list[1][3:]) / 100
inc_previous_price2 = int(inc_previous_data2_close_list[1][:2]) + int(inc_previous_data2_close_list[1][3:]) / 100
inc_previous_price3 = int(inc_previous_data3_close_list[1][:2]) + int(inc_previous_data3_close_list[1][3:]) / 100

if len(inc_previous_data_close_list[1][3:]) == 1:
    inc_previous_price = int(inc_previous_data_close_list[1][:2]) + int(inc_previous_data_close_list[1][3:] + str(0)) / 100

if len(inc_previous_data2_close_list[1][3:]) == 1:
    inc_previous_price2 = int(inc_previous_data2_close_list[1][:2]) + int(inc_previous_data2_close_list[1][3:] + str(0)) / 100

if len(inc_previous_data3_close_list[1][3:]) == 1:
    inc_previous_price3 = int(inc_previous_data3_close_list[1][:2]) + int(inc_previous_data3_close_list[1][3:] + str(0)) / 100
