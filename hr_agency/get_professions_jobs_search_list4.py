...
professions_list = []
file = "/home/time-traveller/macros/scripts/cdh/hr/formatted/filtered/hr_agency_jobs_search_jobs4.txt"
...
for i in range(100):
    ...
    lexemas = [lexema_or, lexema_er, lexema_ist, lexema_yst, lexema_ant, lexema_ident, lexema_tect, lexema_ate, lexema_tive, lexema_ief]
    suffix_length = 6

    inappropriates = ["Partner", "Interactive", "Summer", "Late", "Cashier", "Corporate", "Water"]
